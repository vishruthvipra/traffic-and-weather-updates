...
(function () {
    ...
    function trafficDomainController(UserService, SensorService, ReadingService, loggedin, $location) {
        var vm = this;
        ...
        function createUser(newUser) {
            if (!(user.role === "ADMIN" || user.role === "WADMIN" || user === null)) {
                ...
                vm.error = "Role cannot be other than NORMAL and TADMIN";
            }
        }
        ...
        function updateUser(oldUserId, updUser) {
            ...
            UserService
                ...
                .success(function (user) {
                    if (user.role !== "NORMAL" || user.role !== "TADMIN" || user === null) {
